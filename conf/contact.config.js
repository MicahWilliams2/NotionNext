...
module.exports = {
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'michael@godofmachining.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'www.linkedin.com/in/godofmachining', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/godofmachining/?hl=en', // 您的instagram地址
  CONTACT_TIKTOK: process.env.NEXT_PUBLIC_CONTACT_TIKTOK || 'https://www.tiktok.com/@godofmachining', // 您的TIKTOK地址
